    ...
    <div class="row">
        <div class="my-row col-sm-12">
            ...
            <div class="flipclock">
                ...
                <div class="digit hour" title="Horas">
                    <span class="base"></span>
                    <div class="flap over front"></div>
                    <div class="flap over back"></div>
                    <div class="flap under"></div>
                ...
                <div class="digit tenmin" title="Minutos">
                    <span class="base"></span>
                    <div class="flap over front"></div>
                    <div class="flap over back"></div>
                    <div class="flap under"></div>
                ...
                <div class="digit min" title="Minutos">
                    <span class="base"></span>
                    <div class="flap over front"></div>
                    <div class="flap over back"></div>
                    <div class="flap under"></div>
                ...
                <div class="digit tensec" title="Segundos">
                    <span class="base"></span>
                    <div class="flap over front"></div>
                    <div class="flap over back"></div>
                    <div class="flap under"></div>
                ...
                <div class="digit sec" title="Segundos">
                    <span class="base"></span>
                    <div class="flap over front"></div>
                    <div class="flap over back"></div>
                    <div class="flap under"></div>
